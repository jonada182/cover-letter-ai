...
const PageCardButton = (props: Props) => {
  return (
    <Link href={props.url} className={`flex flex-col hover:opacity-80 transition-all p-6 text-center gap-2 items-center justify-center w-full h-46 rounded-xl shadow-lg bg-gradient-to-t text-white ${getTheme(props.theme)}`}>
